<template>
  <div class="space-y-4">
    <div class="flex items-center gap-3">
      ...
      <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Anmerkungen einbrennen (Flatten)</h2>
    </div>

    <div class="p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg text-sm text-blue-800 dark:text-blue-300">
      Wandelt alle Kommentare, Markierungen und Formularinhalte in festen Seiteninhalt um —
    ...
    <div v-if="done" class="p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-700 rounded-lg text-sm text-green-700 dark:text-green-300">
      Anmerkungen eingebrannt, Datei heruntergeladen.
    </div>
