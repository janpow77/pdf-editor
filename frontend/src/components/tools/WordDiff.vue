  ...
  <div class="space-y-4">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
      ...
      >
        ...
        <div v-if="!fileA">
          <button class="px-3 py-1.5 bg-purple-600 text-white rounded-lg text-sm hover:bg-purple-700" @click="($refs.fileInputA as HTMLInputElement).click()">Auswählen</button>
        </div>
        <div v-else>
      ...
      >
        ...
        <div v-if="!fileB">
          <button class="px-3 py-1.5 bg-purple-600 text-white rounded-lg text-sm hover:bg-purple-700" @click="($refs.fileInputB as HTMLInputElement).click()">Auswählen</button>
        </div>
        <div v-else>
    ...
    <div v-if="result" class="space-y-4">
      ...
      <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 p-4">
        <div class="grid grid-cols-2 sm:grid-cols-5 gap-4 text-center">
          <div>
            <p class="text-2xl font-bold text-purple-600">{{ result.similarity }}%</p>
      ...
      <div class="flex gap-2">
        <button
          ...
          :class="showFilter === f.value ? 'bg-purple-600 text-white' : 'bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300'"
